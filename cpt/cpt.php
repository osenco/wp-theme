...
if (!class_exists('adg_custom_post_types')) {
    class adg_custom_post_types
    {
        ...
        {
            wp_enqueue_style($this->cpt_ui_name . '_css', get_stylesheet_directory_uri() . '/cpt/assets/style.css');
            wp_enqueue_script($this->cpt_ui_name . '_js', get_stylesheet_directory_uri() . '/cpt/assets/script.js', array('jquery'));
        }

...
<?php if( acf_has_upgrade() ): ?>
	...
	<p><?php _e('Reading upgrade tasks...', 'osen'); ?></p>
	<p class="step-1"><i class="acf-loading"></i> <?php printf(__('Upgrading data to version %s', 'osen'), ACF_VERSION); ?></p>
	<p class="step-2"></p>
	<p class="step-3"><?php echo sprintf( __('Database upgrade complete. <a href="%s">See what\'s new</a>', 'osen' ), admin_url('edit.php?post_type=acf-field-group&page=acf-settings-info') ); ?></p>
			    ...
			    $.ajax({
					...
					success: function( json ){
						...
						// error
							...
							// set response text
							response = '<?php _e('Upgrade failed.', 'osen'); ?>';
...
<?php else: ?>
	...
	<p><?php _e('No updates available.', 'osen'); ?></p>

...
function acf_get_field_type_label( $name = '' ) {
	...
	return $label ? $label : '<span class="acf-tooltip-js" title="'.__('Field type does not exist', 'osen').'">'.__('Unknown', 'osen').'</span>';
}
...
function acf_get_grouped_field_types() {
	...
	$l10n = array(
		'basic'			=> __('Basic', 'osen'),
		'content'		=> __('Content', 'osen'),
		'choice'		=> __('Choice', 'osen'),
		'relational'	=> __('Relational', 'osen'),
		'jquery'		=> __('jQuery', 'osen'),
